// Production version for GoDaddy hosting
import svgPaths from "./imports/svg-ezmggktr9o";

// Standard image imports for production - replace figma:asset imports
// You'll need to export these images from Figma and place them in /public/images/
...
import imgReddoorlogo2Png from "./images/red-door-footer-logo.png";
...
export default function App() {
  // Define team images with exact asset mapping
  const teamImages = [
    imgEdwardChapman,  // Edward Chapman - Designated Broker (Updated professional headshot)
