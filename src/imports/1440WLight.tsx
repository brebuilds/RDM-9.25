import svgPaths from "./svg-vapmwwmjes";
      ...
      <div className="flex flex-col items-center relative size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-start pl-[397.54px] pr-[397.56px] py-0 relative w-full">
          <div className="flex flex-col font-['Montserrat:Light',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ab0000] text-[20px] text-center tracking-[4px] w-full">
            <p className="leading-[normal]">RED DOOR MANAGEMENT</p>
          </div>
        </div>
      </div>
    </div>
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center max-w-[1142.41px] min-h-2.5 min-w-2.5 relative shrink-0 w-full" data-name="Container">
      <Container1 />
    </div>
  );
}
      ...
      <div className="flex flex-col items-center relative size-full">
        <div className="box-border content-stretch flex flex-col items-center justify-start pl-[92.36px] pr-[92.38px] py-0 relative w-full">
          <div className="flex flex-col font-['Montserrat:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[70px] text-center tracking-[11.9px] w-full">
            <p className="leading-[normal]">Multi-Family Rentals</p>
          </div>
        </div>
      </div>
    </div>
...
function Container5() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-6 grow h-[134px] items-start justify-center max-w-[1200px] min-h-2 min-w-12 relative shrink-0" data-name="Container">
      <Container2 />
      <Container4 />
    </div>
  );
...
function Section() {
  return (
    <div className="bg-[#000000] relative shrink-0 w-full" data-name="Section" style={{ marginBottom: "-2.84217e-14px" }}>
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start overflow-clip relative rounded-[15.53px] shrink-0 w-full" data-name="Container">
      <div className="bg-no-repeat bg-size-[127.29%_100%] bg-top h-[450px] shrink-0 w-full" data-name="Link" style={{ backgroundImage: `url('${imgLink}')` }} />
    </div>
  );
}
...
function Container10() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start overflow-clip relative rounded-[15.53px] shrink-0 w-full" data-name="Container">
      <div className="bg-no-repeat bg-size-[102.46%_100%] bg-top h-[450px] shrink-0 w-full" data-name="Link" style={{ backgroundImage: `url('${imgLink1}')` }} />
    </div>
  );
}
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start overflow-clip relative rounded-[15.53px] shrink-0 w-full" data-name="Container">
      <div className="bg-no-repeat bg-size-[115.38%_100%] bg-top h-[450px] shrink-0 w-full" data-name="Link" style={{ backgroundImage: `url('${imgLink2}')` }} />
    </div>
  );
}
...
function Container17() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start overflow-clip relative rounded-[15.53px] shrink-0 w-full" data-name="Container">
      <div className="bg-left bg-no-repeat bg-size-[100%_173.33%] h-[450px] shrink-0 w-full" data-name="Link" style={{ backgroundImage: `url('${imgLink3}')` }} />
    </div>
  );
}
...
function Container21() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start overflow-clip relative rounded-[15.53px] shrink-0 w-full" data-name="Container">
      <div className="bg-no-repeat bg-size-[189.35%_100%] bg-top h-[450px] shrink-0 w-full" data-name="Link" style={{ backgroundImage: `url('${imgLink4}')` }} />
    </div>
  );
}
...
function Container24() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start overflow-clip relative rounded-[15.53px] shrink-0 w-full" data-name="Container">
      <div className="bg-no-repeat bg-size-[156.79%_100%] bg-top h-[450px] shrink-0 w-full" data-name="Link" style={{ backgroundImage: `url('${imgLink5}')` }} />
    </div>
  );
}
...
function Container28() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start overflow-clip relative rounded-[15.53px] shrink-0 w-full" data-name="Container">
      <div className="bg-no-repeat bg-size-[132.25%_100%] bg-top h-[450px] shrink-0 w-full" data-name="Link" style={{ backgroundImage: `url('${imgLink6}')` }} />
    </div>
  );
}
...
function Container31() {
  return (
    <div className="content-stretch flex flex-col items-start justify-start overflow-clip relative rounded-[15.53px] shrink-0 w-full" data-name="Container">
      <div className="bg-no-repeat bg-size-[232.22%_100%] bg-top h-[450px] shrink-0 w-full" data-name="Link" style={{ backgroundImage: `url('${imgLink7}')` }} />
    </div>
  );
}
...
function Container37() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start justify-center max-w-[1200px] min-h-2.5 min-w-2.5 relative shrink-0" data-name="Container">
      <Container36 />
    </div>
  );
}
...
function Container38() {
  return (
    <div className="box-border content-stretch flex items-center justify-start max-w-[1200px] min-h-[460px] pb-[100px] pt-[57.594px] px-0 relative shrink-0 w-full" data-name="Container">
      <Container37 />
    </div>
  );
}
...
function Component3() {
  return (
    <div className="box-border content-stretch flex h-full items-center justify-start px-3 py-0 relative shrink-0" data-name="Component 3">
      <Container47 />
    </div>
  );
}
...
function Container51() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[2.79px] items-start justify-start pb-0 pt-[4.8px] px-0 relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[0px] text-center text-nowrap tracking-[0.42px]">
        <p className="leading-[normal] text-[14px] whitespace-pre">Multifamily Rentals</p>
      </div>
      <div className="h-px relative shrink-0 w-[142.61px]" data-name="Horizontal Divider">
        <div aria-hidden="true" className="absolute border-[#2c393f] border-[1px_0px_0px] border-solid inset-0 pointer-events-none" />
      </div>
    </div>
  );
}
...
function Component17() {
  return (
    <a className="box-border content-stretch cursor-pointer flex h-full items-center justify-start overflow-visible px-3 py-0 relative shrink-0" data-name="Component 3" href="https://www.rdm-az.com/portfolio">
      <Container51 />
    </a>
  );
}
...
function Background() {
  return (
    <div className="absolute bg-[#ffffff] content-stretch flex flex-col items-start justify-start left-0 right-0 top-[2386.44px]" data-name="Background">
      <Section2 />
      <Section3 />
    </div>
  );
...
function Component6() {
  return (
    <div className="box-border content-stretch flex h-full items-center justify-start px-[15px] py-0 relative shrink-0" data-name="Component 6">
      <Container70 />
    </div>
  );
}
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-[3.18px] items-start justify-start pb-[0.01px] pt-[5.19px] px-0 relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[0px] text-center text-nowrap tracking-[0.48px]">
        <p className="leading-[normal] text-[16px] whitespace-pre">Multifamily Rentals</p>
      </div>
...
function Component23() {
  return (
    <a className="box-border content-stretch cursor-pointer flex h-full items-center justify-start overflow-visible px-[15px] py-0 relative shrink-0" data-name="Component 6" href="https://www.rdm-az.com/portfolio">
      <Container74 />
    </a>
  );
}
...
function Container75() {
  return (
    <div className="box-border content-stretch flex flex-col items-center justify-start pb-[4.19px] pt-[5.19px] px-0 relative shrink-0" data-name="Container">
      <a className="[white-space-collapse:collapse] flex flex-col font-['Montserrat:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[0px] text-center text-nowrap tracking-[0.48px]" href="https://www.rdm-az.com/">
        <p className="cursor-pointer leading-[normal] text-[16px] whitespace-pre">Vacation Rentals</p>
      </a>
    </div>
  );
}
